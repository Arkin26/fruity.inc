...
export function FeaturedCards() {
  return (
    <section className="px-2 pt-2 pb-12 sm:pb-16 md:px-4 md:pb-20">
      <div className="mx-auto grid w-[80%] grid-cols-1 gap-2 md:aspect-[8/7] md:grid-cols-[2fr_3fr] md:gap-3">
        <SalesBox />
...
function SalesBox() {
  return (
    <Link
      ...
      className="group relative flex aspect-[8/7] h-full min-h-0 flex-col items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-black px-6 text-center md:aspect-auto"
    >
      <div
...
function CollectionCard({
  ...
  return (
    <Link
      href={card.href}
      className="group relative block aspect-[8/7] h-full min-h-0 overflow-hidden rounded-2xl border border-white/10 md:aspect-auto"
    >
      <div
